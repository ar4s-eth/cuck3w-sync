...
sync:
	...
	mkdir "${SYNC_DIR}"
	rsync -ar --mkpath --exclude='*.md' "${LIBS_DIR}/UberGuidoZ_Flipper/Sub-GHz/" "${SYNC_DIR}/subghz"
	rsync -ar --mkpath --exclude='*.md' "${LIBS_DIR}/UberGuidoZ_Flipper/NFC/" "${SYNC_DIR}/nfc"
	mkdir "${SYNC_DIR}/nfc/assets"
	cp "${SYNC_DIR}/nfc/mf_classic_dict/mf_classic_dict.nfc" "${SYNC_DIR}/nfc/assets/mf_classic_dict.nfc"
	rsync -ar --mkpath --exclude='*.md' "${LIBS_DIR}/UberGuidoZ_Flipper/Music_Player/" "${SYNC_DIR}/music_player"
